...
QT_MOC_LITERAL(1, 11, 24), // "on_lineScale_textChanged"
...
QT_MOC_LITERAL(6, 80, 6) // "button"
    ...
    "GotoDialog\0on_lineScale_textChanged\0"
    "\0text\0on_buttonBox_clicked\0QAbstractButton*\0"
    "button"
};
...
void GotoDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_lineScale_textChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;

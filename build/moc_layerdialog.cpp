...
QT_MOC_LITERAL(3, 19, 13), // "onRadioChange"
QT_MOC_LITERAL(4, 33, 13), // "onComboChange"
QT_MOC_LITERAL(5, 47, 10), // "QComboBox*"
QT_MOC_LITERAL(6, 58, 5), // "combo"
QT_MOC_LITERAL(7, 64, 20), // "on_buttonBox_clicked"
QT_MOC_LITERAL(8, 85, 16), // "QAbstractButton*"
QT_MOC_LITERAL(9, 102, 6) // "button"

    },
    "LayerDialog\0apply\0\0onRadioChange\0"
    "onComboChange\0QComboBox*\0combo\0"
...
void LayerDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onRadioChange(); break;
        case 2: _t->onComboChange((*reinterpret_cast< QComboBox*(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LayerDialog::apply)) {
                *result = 0;
                return;
            }
        }

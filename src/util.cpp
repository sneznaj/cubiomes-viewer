...
static QString getBiomeDisplayBedrock(int id)
{
    /* Fallback names for Bedrock biome IDs (cubiomes-bedrock uses same IDs as Java for overworld). */
    switch (id)
    {
    case 0:  return QApplication::translate("Biome", "Ocean");
    case 1:  return QApplication::translate("Biome", "Plains");
    case 2:  return QApplication::translate("Biome", "Desert");
    case 3:  return QApplication::translate("Biome", "Mountains");
    case 4:  return QApplication::translate("Biome", "Forest");
    case 5:  return QApplication::translate("Biome", "Taiga");
    case 6:  return QApplication::translate("Biome", "Swamp");
    case 7:  return QApplication::translate("Biome", "River");
    case 8:  return QApplication::translate("Biome", "Nether Wastes");
    case 9:  return QApplication::translate("Biome", "The End");
    case 10: return QApplication::translate("Biome", "Frozen Ocean");
    default: return QApplication::translate("Biome", "Biome %1").arg(id);
    }
}
...
{
    if (mc == MC_BEDROCK)
        return getBiomeDisplayBedrock(id);
    if (mc >= MC_1_18)
    {
